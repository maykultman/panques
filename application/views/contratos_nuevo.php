				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="text" id="input_Representante" class="form-control" disabled placeholder="Representante">
							<input type="hidden" id="hidden_idRepresentante" name="idrepresentante">					
						</div>
						<div class="col-md-6">
							<input type="text" class="form-control" name="titulocontrato" placeholder="Nombre para el contrato">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="div_table_overflow">
								<table id="table_servicios" class="table table-hover">
