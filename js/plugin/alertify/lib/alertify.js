	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				ok     : "<a href=\"#\" class=\"btn btn-default\" id=\"alertify-ok\">{{ok}}</a>",/*ok     : "<a href=\"#\" class=\"alertify-button alertify-button-ok\" id=\"alertify-ok\">{{ok}}</a>",*/
				cancel : "<a href=\"#\" class=\"btn btn-default\" id=\"alertify-cancel\">{{cancel}}</a>"/*cancel : "<a href=\"#\" class=\"alertify-button alertify-button-cancel\" id=\"alertify-cancel\">{{cancel}}</a>"*/
			},
