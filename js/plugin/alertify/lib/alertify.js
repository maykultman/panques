	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				ok     : "<a href=\"#\" class=\"btn btn-default\" id=\"alertify-ok\" style=\"margin:5px;\">{{ok}}</a>",/*ok     : "<a href=\"#\" class=\"alertify-button alertify-button-ok\" id=\"alertify-ok\">{{ok}}</a>",*/
				cancel : "<a href=\"#\" class=\"btn btn-default\" id=\"alertify-cancel\" style=\"margin:5px;\">{{cancel}}</a>"/*cancel : "<a href=\"#\" class=\"alertify-button alertify-button-cancel\" id=\"alertify-cancel\">{{cancel}}</a>"*/
			},
