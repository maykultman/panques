...
app.VistaServicioCotizacion = app.TrServicio.extend({
	tagName : 'tr',
...
app.VistaNuevaCotizacion = Backbone.View.extend({
	el : '.contenedor_principal_modulos',
				...
				events : {
						...
						/*Botones de los servicios cotizados*/
				...
				initialize : function () 
				{
					...
					// var here = this;
					// this.$('#span_verMenos').on('click', function () {
					// 	here.$('.22').toggle(1000);
					// });
				},
				...
				cargarServicioCo	: function (serviciosCotizacion) {
					 /*....................Instanciamos un modelo servicios y le pasamos el modelo.............*/
							...
							this.$('#tbody_servicios').append( vistaServicioCotizacion.render().el );
				},
